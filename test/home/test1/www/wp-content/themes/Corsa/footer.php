...
?><script>
	...
	<?php if ($smof_data['logo_height'] != "" AND $smof_data['logo_height'] != "50%") {?>jQuery(document).ready(function() { jQuery('.w-logo-img').css('height', '<?php echo $smof_data['logo_height'] ?>')});<?php } ?>
</script>
