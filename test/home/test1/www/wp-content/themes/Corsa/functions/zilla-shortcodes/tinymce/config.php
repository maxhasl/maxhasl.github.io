...
$us_zilla_shortcodes['team'] = array(
	...
	'child_shortcode' => array(
		...
		'shortcode' => '<br>[member name="{{name}}" role="{{role}}" img="{{img}}" facebook="{{facebook}}" twitter="{{twitter}}" linkedin="{{linkedin}}"]',
...
$us_zilla_shortcodes['contacts'] = array(
	...
	'shortcode' => '[contacts address="{{address}}" phone="{{phone}}" email="{{email}}"]',
...
$us_zilla_shortcodes['social_links'] = array(
	...
	'shortcode' => '[social_links size="{{size}}" email="{{email}}" facebook="{{facebook}}" twitter="{{twitter}}" google="{{google}}" linkedin="{{linkedin}}" youtube="{{youtube}}" flickr="{{flickr}}" instagram="{{instagram}}" pinterest="{{pinterest}}" skype="{{skype}}" tumblr="{{tumblr}}" dribbble="{{dribbble}}" vk="{{vk}}" rss="{{rss}}"]',
