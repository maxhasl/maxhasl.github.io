...
<div class="w-blog-load" style="text-align: center; padding-top: 15px;">
<a href="javascript:void(0);" id="blog_load_more" class="g-btn type_default size_small"><span>Load More Posts</span></a>
<img id="spinner" src="'.get_template_directory_uri().'/img/loader2.gif" style="display: none;">
</div>';
		}
	...
	public function member ($attributes, $content = null)
	{
		...
		if ($attributes['facebook'] != '' OR $attributes['twitter'] != '' OR $attributes['linkedin'] != '')
		{
...
function us_tinymce_buttons($buttons) {
	array_push($buttons, "columns", "typography", "separator_btn", "button", "tabs", "accordion", "toggle", "icon", "iconbox", "video", "fullscreen_slider", "portfolio", "blog", "testimonial", "team", "contacts", "contacts_form", "social_links", "gmaps", "actionbox", "subsection", "pricing_table", "message_box", "counter", "clients");
	return $buttons;
}
...
function us_tinymce_plugin($plugin_array) {
	...
	$plugin_array['horizontal_blocks'] = get_template_directory_uri().'/functions/tinymce/buttons.js';
	...
	$plugin_array['bottom_buttons'] = get_template_directory_uri().'/functions/tinymce/buttons.js';
	$plugin_array['shop'] = get_template_directory_uri().'/functions/tinymce/buttons.js';
	$plugin_array['link_block'] = get_template_directory_uri().'/functions/tinymce/buttons.js';
	$plugin_array['typography'] = get_template_directory_uri().'/functions/tinymce/buttons.js';
	$plugin_array['vertical_blocks'] = get_template_directory_uri().'/functions/tinymce/buttons.js';
	$plugin_array['offer'] = get_template_directory_uri().'/functions/tinymce/buttons.js';
