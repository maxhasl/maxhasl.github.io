...
$(function(){
  ...
  function bannerLink(){
      ...
      if(windowSize>1023){
        createMainLink('.link__svg--banner',
    ...
    if(jQuery(window).width()> 1023) {
        verticalAlign('.banner__wrapper', '.banner');
    } else {
        jQuery('.banner__wrapper').css({marginTop : 0});
    }
    
  bannerLink();
  $(window).resize(function(){
      deleteLink('.link__svg--banner');
      bannerLink();
